...
#Summon Sprout
execute at @e[type=armor_stand,tag=Brussel_Up,scores={AbilityCD=100..}] if entity @e[tag=Zombie,dx=0,dy=0,dz=-18,limit=1] as @s run summon armor_stand ~ ~ ~ {CustomName:"{\"text\":\"Sprout\"}",Tags:[Sprout,Projectile],NoGravity:1,Invisible:1,Marker:1,ArmorItems:[{},{},{},{id:iron_hoe,Count:1,tag:{Unbreakable:1,CustomModelData:11}}]}
#Reset
